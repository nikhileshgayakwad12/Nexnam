      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[rgba(91,92,246,0.08)] border border-[rgba(91,92,246,0.16)] text-xs text-[#5B5CF6] font-semibold tracking-wide uppercase font-mono mb-6"
          >
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-5xl font-bold tracking-tight text-[#0B0D12] mb-6 leading-tight"
          >
            About{" "}
        ...
        <div className="grid grid-cols-1 gap-12 mb-24">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="rounded-2xl p-8 md:p-12 border border-slate-900/[0.08] bg-white shadow-xs"
          >
            <h2 className="text-2xl font-bold text-[#0B0D12] mb-4">Who We Are</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="glass-card rounded-2xl p-8 border border-slate-200/80 bg-white/80 shadow-sm flex flex-col justify-between"
            >
              <div>
                <div className="w-10 h-10 rounded-xl bg-indigo-50 border border-indigo-100 flex items-center justify-center mb-6">
            ...
            >
              <div>
                <div className="w-10 h-10 rounded-xl bg-violet-50 border border-violet-100 flex items-center justify-center mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-24">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="glass-card rounded-2xl p-8 border border-slate-200/80 bg-white/80 hover:border-violet-200 hover:shadow-md transition-all duration-300"
          >
            <h3 className="text-xl font-bold text-slate-900 mb-4 flex items-center gap-2">
              <span className="w-1.5 h-6 rounded-full bg-violet-600" />
              Why Nexnam Exists
            </h3>
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="glass-card rounded-2xl p-8 border border-slate-200/80 bg-white/80 hover:border-indigo-200 hover:shadow-md transition-all duration-300"
          >
            <h3 className="text-xl font-bold text-slate-900 mb-4 flex items-center gap-2">
        ...
        <div className="mb-24">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <span className="text-xs font-mono font-bold tracking-widest text-indigo-600 uppercase mb-3 block">
              Our Compass
            </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {values.map((v, idx) => (
              <motion.div
                ...
                className="glass-card rounded-2xl p-6 border border-slate-200/80 bg-white/80 shadow-xs group hover:border-indigo-200 hover:shadow-md transition-all duration-300"
              >
                <div className={`w-10 h-10 rounded-xl flex items-center justify-center mb-4 border ${v.color}`}>
                  <v.icon className="w-5 h-5" />
                </div>
                <h3 className="text-lg font-bold text-slate-900 mb-2 group-hover:text-indigo-600 transition-colors">{v.title}</h3>
        ...
        <div className="mt-24 text-center p-8 md:p-12 rounded-3xl bg-gradient-to-br from-indigo-50/80 via-white to-violet-50/80 border border-indigo-100 shadow-md">
          <h3 className="text-xl font-bold text-slate-900 mb-3 font-mono">Ready to Collaborate with Nexnam?</h3>
          <p className="text-xs text-slate-600 mb-8 max-w-md mx-auto leading-relaxed">
